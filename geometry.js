...
var sideColor = [ 0.0, 1.0, 1.0, 1.0 ];
var topColor = [ 0.0, 1.0, 1.0, 1.0 ];
var bottomColor = [ 0.0, 1.0, 1.0, 1.0 ];
...
function triangle(a, b, c) {
     ...
     */
     sphereVertexColors.push([0.5, 0.5, 1.0, 1.0]);
     sphereVertexColors.push([0.5, 0.5, 1.0, 1.0]);
     sphereVertexColors.push([0.5, 0.5, 1.0, 1.0]);
...
function light0() {
  var data = {};
  data.lightPosition = [5.0, 2.5, 5.0, 1.0 ];;
